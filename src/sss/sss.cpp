...
#define IS_DPROC(Decl)        ((Decl)->kind == DECL_PROC)
...
#define IS_TENUM(T)           ((T)->kind == TYPE_ENUM)
#define IS_TPTR(T)            ((T)->kind == TYPE_PTR)
#define IS_TSTRUCT(T)         ((T)->kind == TYPE_STRUCT)
#define IS_TSTR(T)            ((T)->kind == TYPE_STRING)
#define IS_TNS(T)             ((T)->kind == TYPE_NAMESPACE)
#define IS_TUNION(T)          ((T)->kind == TYPE_UNION)
