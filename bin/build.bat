...
set linker_flags= -libpath:%PROJECT_PATH%/third_party/dyncall-1.2-release/lib -incremental:no -nodefaultlib:LIBCMT -opt:ref
...
cl %compiler_flags% %PROJECT_PATH%\tests\tests.cpp -Fetests.exe /link %linker_flags%
